...
/**
 * Generated class for the GroupusersPage page.
 *
...
export class GroupusersPage 
{
  ...
  ionViewWillEnter() 
  {
    ...
    this.events.subscribe('gotintogroup', () => {
      this.myfriends.splice(this.myfriends.indexOf(this.newuser.uid), 1);
  ...
  {
    this.newuser = userid;
    this.groupservice.addmember(userid);
  }
